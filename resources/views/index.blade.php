...
<body class="bg-white">
    ...
    <section class="login_part section_padding">
        <h1 class="text-center"><a class="nav-link" href="#">Indonesia Live Data Virus Covid-19. Sumber data : Kementerian Kesehatan & JHU. Update terakhir : {{ $hari_ini }} </a></h1>
        <hr>
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card bg-warning mb-3">
                        <div class="card-header text-center"><a class="nav-link" href="#"><h6 style="font-size:200%; color: white;">Total Positif</h6></a></div>
                        <div class="card-body text-center">
                            <img src="winter/img/sad.png" width="20%" alt="logo">
                            <p class="card-text" style="color: white; font-size:160%;">{{ $positif }} Orang</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card bg-success mb-3">
                        <div class="card-header text-center"><a class="nav-link" href="#"><h6 style="font-size:200%; color: white;">Total Sembuh</h6></a></div>
                        <div class="card-body text-center">
                            <img src="winter/img/smile.png" width="20%" alt="logo">
                            <p class="card-text" style="color: white; font-size:160%;">{{ $sembuh }} Orang</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card bg-danger mb-3">
                        <div class="card-header text-center"><a class="nav-link" href="#"><h6 style="font-size:200%; color: white;">Total Meninggal</h6></a></div>
                        <div class="card-body text-center">
                            <img src="winter/img/emoji.png" width="20%" alt="logo">
                            <p class="card-text" style="color: white; font-size:160%;">{{ $meninggal }} Orang</p>
                        </div>
                    </div>
                </div>
            </div>
